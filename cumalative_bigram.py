...
class CumalativeScore(MRJob):
	"""Find the cumalative positive scores for the bigrams in the partially processed dataset."""

	# Each line of the input file will be delivered as key-value pair to the mapper; the key being the bigram
	DEFAULT_INPUT_PROTOCOL = 'json_value'

	def mapper(self, _, data):
		yield data["bi_gram"],(data["score"]/100.0,data["count"])
